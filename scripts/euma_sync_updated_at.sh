...
php artisan geohub:sync-ec-from-out-source-updated-at poi euma@webmapp.it --endpoint="https://database.european-mountaineers.eu/api/v1/hut/list" --provider=OutSourceImporterFeatureEUMA --name_format="{name}" --theme="euma-pois-huts"

php artisan geohub:sync-ec-from-out-source-updated-at poi euma@webmapp.it --endpoint="https://database.european-mountaineers.eu/api/v1/climbingrockarea/list" --provider=OutSourceImporterFeatureEUMA --name_format="{name}" --theme="euma-pois-crags"
...
php artisan geohub:index-tracks 30 
