...
class BulkEditPOIColorAction extends Action
{
    ...
    public function fields()
    {
        return [
            Swatches::make('Color')
                ...
                ->help('Add # before the hex code</br>Example: #000000</br></br></br></br></br></br></br></br></br></br></br>'),
            // The </br> is needed fot the popup display
        ];
    }

    public function name()
    {
        return 'Bulk Assign color';
    }
}
