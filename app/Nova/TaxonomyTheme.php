        ...
        return [
            ...
            NovaTabTranslatable::make([
                Text::make(__('Name'), 'name')
                    ->sortable()
                    ->help(__('Enter the name of the item. This will be the main title displayed')),
                CKEditor::make(__('Description'), 'description')
                    ->hideFromIndex()
                    ->help(__('Add a detailed description. This field is for the full content that users will see..')),
            ...
            ExternalImage::make(__('Feature Image'), function () {
                ...
                ->hideWhenUpdating()
                ->hideFromIndex()
                ->help(__('Feature Image: The main image associated with this taxonomy.')),
