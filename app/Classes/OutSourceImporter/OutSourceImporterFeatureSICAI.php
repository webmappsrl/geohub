...
class OutSourceImporterFeatureSICAI extends OutSourceImporterFeatureAbstract { 
    ...
    protected function preparePOITagsJson($poi){
        ...
        if (isset($poi['immagine']) && $poi['immagine']) {
            ...
            $this->tags['feature_image'] = $this->createOSFMedia($base,$poi['immagine'],$poi,000);
        }
        ...
        if (isset($poi['foto02']) && $poi['foto02']) {
            ...
            $base = 'https://sentieroitaliamappe.cai.it/index.php/view/media/getMedia?repository=sicaipubblico&project=SICAI_Pubblico&path=';
            $this->tags['image_gallery'][] = $this->createOSFMedia($base,$poi['immagine'],$poi,001);
        }
        ...
        if (isset($poi['foto03']) && $poi['foto03']) {
            ...
            $base = 'https://sentieroitaliamappe.cai.it/index.php/view/media/getMedia?repository=sicaipubblico&project=SICAI_Pubblico&path=';
            $this->tags['image_gallery'][] = $this->createOSFMedia($base,$poi['immagine'],$poi,003);
        }
        ...
        if (isset($poi['foto04']) && $poi['foto04']) {
            ...
            $base = 'https://sentieroitaliamappe.cai.it/index.php/view/media/getMedia?repository=sicaipubblico&project=SICAI_Pubblico&path=';
            $this->tags['image_gallery'][] = $this->createOSFMedia($base,$poi['immagine'],$poi,004);
        }
        ...
        if (isset($poi['foto05']) && $poi['foto05']) {
            ...
            $base = 'https://sentieroitaliamappe.cai.it/index.php/view/media/getMedia?repository=sicaipubblico&project=SICAI_Pubblico&path=';
            $this->tags['image_gallery'][] = $this->createOSFMedia($base,$poi['immagine'],$poi,005);
        }
     ...
     * 
     */
    public function createOSFMedia($base,$image,$poi,$suffix){ 
