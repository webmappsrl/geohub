...
trait ConfTrait
{
    ...
    private function config_section_options(): array
    {
        ...
        $data['OPTIONS']['showDownloadTilesButton'] = $this->show_download_tiles_button; // TODO: opzione usata fino a versione 3.1.6 e precedenti sostituita da showDownloadTiles
        $data['OPTIONS']['showDownloadTiles'] = $this->show_download_tiles_button;
