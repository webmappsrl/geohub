...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        HoquServiceProvider::class,
        EcTrackServiceProvider::class,
        PartnershipValidationProvider::class,
        OutSourceSentieroItaliaProvider::class,
        OutSourceOSMProvider::class,
        CurlServiceProvider::class,
        OsmServiceProvider::class,
    ...
    */
    ...
    'ugc_webhook_url' => env('UGC_WEBHOOK_URL', 'https://osm2cai.prod.maphub.it'),
