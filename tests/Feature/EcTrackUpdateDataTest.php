...
class UpdateTrackDataTest extends TestCase
{
    ...
    public function testCreateTrackWithOsmId()
    {
        $data = $this->baseData();
    ...
    public function testUpdateTrackWithOsmId()
    {
        $data = $this->baseData();
        $ecTrack = EcTrack::forceCreate($data)->refresh();
    ...
    public function testCreateTrackWithOsmIdAndData()
    {
        $data = $this->baseData();
        $data['ele_min'] = 334;
        $ecTrack = EcTrack::forceCreate($data)->refresh();
    ...
    public function testUpdateTrackWithOsmIdAndData()
    {
        $data = $this->baseData();
        $data['ele_min'] = 333;
        $ecTrack = EcTrack::forceCreate($data)->refresh();
    ...
    public function testCreateTrackWithoutOsmId()
    {
        $data = $this->baseData();
        unset($data['osmid']);
        $ecTrack = EcTrack::forceCreate($data)->refresh();
    ...
    public function testUpdateTrackWithoutOsmId()
    {
        $data = $this->baseData();
        unset($data['osmid']);
        $ecTrack = EcTrack::forceCreate($data)->refresh();
    ...
    public function testCreateTrackWithoutOsmIdAndData()
    {
        $data = $this->baseData();
        $data['ele_min'] = 333;
        unset($data['osmid']);
    ...
    public function testUpdateTrackWithoutOsmIdAndData()
    {
        $data = $this->baseData();
        $data['ele_min'] = 333;
        unset($data['osmid']);
    ...
    public function testCreateTrackWithInvalidData()
    {
        $data = $this->baseData();
        $data['osmid'] = 'invalid';
    ...
    public function checkFields($ecTrack)
    {
        ...
        foreach ($ecTrack->getDemDataFields() as $field) {
            if (!is_null($ecTrack->$field)) {
                ...
                } else if (isset($osmData->$field) && !is_null($osmData->$field))
                    $this->assertEquals($ecTrack->$field, $osmData[$field]);
                else if (isset($demData->$field) && !is_null($demData->$field)) {
