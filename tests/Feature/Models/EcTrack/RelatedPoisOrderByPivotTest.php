...
class RelatedPoisOrderByPivotTest extends TestCase
{
     ...
     * @test
     */
    public function when_order_is_properly_set_related_pois_are_properly_ordered()
    {
     ...
     * @test
     */
    public function when_order_is_properly_set_related_pois_are_properly_ordered_also_with_four_pois()
    {
        $poi1 = EcPoi::factory()->create();
        $poi2 = EcPoi::factory()->create();
