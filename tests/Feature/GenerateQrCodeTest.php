...
class GenerateQrCodeTest extends TestCase
{
     ...
     * @return void
     */
    public function test_genereate_qr_code_fill_the_qr_code_column_in_database()
    {
        // create an app
     ...
     * @return void
     */
    public function test_generate_qr_code_return_a_valid_svg()
    {
        // create an app
        $app = App::factory()->create();
     ...
     * @return void
     */
    public function test_generate_qr_code_create_the_correct_directory()
    {
        // create an app
        $app = App::factory()->create();
